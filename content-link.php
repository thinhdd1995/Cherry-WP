<article id="post-<?php the_ID(); ?>" <?php post_class("col-md-6 post_link"); ?> >
	<div class="entry-header">
		<?php 
			...
			if( is_single() ){
				...
				printf( '<h2 class"entry-title-link"><a href="%1$s" target="blank">%2$s</a></h2>',
				$link,
				get_the_title() );
			}
		?>
	...
	<div class="entry-content">
		<?php 
			printf( '<a href="%1$s" target="blank"><i class="fa fa-link" aria-hidden="true"> </i>&nbsp;  %2$s </a>',
